...
All events are **FREE for members of Tuspark and the Bitcoin Association of Hong Kong**. To rsvp please use the provided links or send us an email to [info@bitcoinhk.org](mailto:info@bitcoinhk.org).
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s); js.id=id;js.async=true;js.src="https://a248.e.akamai.net/secure.meetupstatic.com/s/script/541522619002077648/api/mu.btns.js?id=i47a6bqrn5seiu4g8ikkm3b7q";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","mu-bootjs");</script>
